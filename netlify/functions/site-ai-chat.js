...
function buildSystemPrompt(settings){
  const parts = [];
  parts.push(`Sen "VIP RAQAMLAR AI" — VIP RAQAMLAR (070.uz — O'zbekistondagi chiroyli/oltin/VIP telefon raqamlari do'koni) saytida ishlaydigan yordamchisan. Saytga kirgan mehmonlar bilan gaplashasan.`);
  parts.push(`QOIDALAR:
